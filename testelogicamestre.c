...
printf("Para começarmos, eu vou precisar que você cadastre duas cartas.");
printf("Para isso, vou fazer algumas perguntas, Ok?!\n\n");

//Coletando dados do usuario abaixo:

printf("Primeiramente, peço que escolha uma cidade de apenas uma palavra");
printf("(Por exemplo: Lisboa) e a digite abaixo: \n");
    scanf("%s", cidade);

printf("Perfeito, agora me diga a primeira letra do estado da cidade escolhida: \n");
    scanf(" %c", &estado);

printf("Com a informação anterior, crie um código para a sua carta."); 
printf("O código é composto pela letra do estado da cidade seguida de um numero de 01 a 04 (Ex: S01): \n");
    scanf("%s", codcarta);

printf("Estamos prosseguindo, qual a área em Km2 da cidade escolhida?\n");
    scanf("%f", &area);

printf("Ótimo, qual a população dessa cidade?\n");
    scanf("%lu", &pop);

printf("Uau, me diga o PIB dessa cidade: \n");
    scanf("%f", &PIB);

printf("Cidade interessante, sabe me dizer quantos pontos turísticos tem nela? \n");
...
printf("\n\n ***Sua carta foi cadastrada com sucesso!*** \n\n");
printf("Carta 01: \n");
printf("Cidade: %s\n", cidade);
printf("Estado: %c\n", estado);
...
// Introduzindo ao usuário a segunda carta

printf("\n Agora, podemos prosseguir para a segunda carta, vamos lá?\n");
printf("Me diga uma cidade: \n");
    scanf(" %c", cidade2);

printf("Agora, a primeira letra do estado da cidade escolhida: \n");
    scanf(" %s", &estado2);

printf("Agora crie o código da sua carta, composto pela letra do estado e um número de 01 a 04: \n");
    scanf("%s", codcarta2);

printf("Qual a área dessa tal cidade? \n");
    scanf("%f", &area2);
...
// IMPRIMINDO VALORES DA CARTA 02:
...
// Escolha de atributo do jogador.
...
if (area > area2) { printf("A cidade 1 ganhou em Área!\n"); } 


else if (area<area2) { printf("A cidade 2 ganhou em Área\n"); } 
...
if (PIB>PIB2) { printf("A cidade 1 ganhou em PIB!\n"); } 


else if (PIB<PIB2) { printf("A cidade 2 ganhou em PIB!\n"); } 


else { printf("As duas cidades empataram em relação ao PIB!");}
...
if (ptsturisticos>ptsturisticos2) { printf("A cidade 1 ganhou em número pontos turísticos!\n"); }


else if (ptsturisticos<ptsturisticos2) { printf("A cidade 2 ganhou em número de pontos turísticos!\n"); }


else { printf("As duas cidades empataram em relação ao número de pontos turísticos!\n"); }
...
if (densidadep<densidadep2) {printf("A cidade 1 ganhou em densidade demográfica!\n"); }


else if (densidadep>densidadep2) { printf("A cidade 2 ganhou em densidade demográfica!\n"); } 
...
// Escolha de segundo atributo do jogador.
