...
printf("Agora avaliado essas condições, peço que selecione uma das categorias abaixo para a comparação entre as cartas.\n");
printf("1. População\n");
printf("2. Área\n");
printf("3. PIB\n");
...
case 1:
printf("CARTA 1: %s\n", cidade);
    printf("População Carta 1: %lu", pop);
printf("CARTA 02: %s\n", cidade2);
    printf("População Carta 2: %lu", pop2);
...
case 2:
printf("CARTA 1: %s\n", cidade);
    printf("Área Carta 1: %f", area);
printf("CARTA 02: %s\n", cidade2);
    printf("Área Carta 2: %f", area2);
    if(area > area2){ 
...
case 3:
printf("CARTA 1: %s\n", cidade);
    printf("PIB Carta 1: %f", PIB);
printf("CARTA 02: %s\n", cidade2);
    printf("PIB Carta 2: %f", PIB2);
    if(PIB>PIB2){
...
break;
 case 4:
printf("CARTA 1: %s\n", cidade);
    printf("Pontos Turísticos Carta 1: %d", ptsturisticos);
printf("CARTA 02: %s\n", cidade2);
    printf("Pontos Turísticos carta 2: %d", ptsturisticos2);
